...
const Detail = ({ all }) => {
  ...
  const foundElement = all.find((el) => el.id === parseInt(params.id));
  ...
  const htmlCode = `${foundElement.html}`;
  const scssCode = `${foundElement.scss}`;
    ...
    <>
      ...
      <div className="detail">
        <div className="card detailCard">
          {foundElement ? <>{foundElement.component}</> : "error"}
        </div>
        <div className="html">
