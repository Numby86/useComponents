...
const DetailToggle = ({ listToggles }) => {
  const params = useParams();

  const foundToggle = listToggles.find((el) => el.id === parseInt(params.id));
  ...
  const htmlCode = `${foundToggle.html}`;
  const scssCode = `${foundToggle.scss}`;
    ...
    <>
      ...
      <div className="detail">
        <div className="card detailCard">
          {foundToggle ? <>{foundToggle.component}</> : "error"}
        </div>
        <div className="html">
